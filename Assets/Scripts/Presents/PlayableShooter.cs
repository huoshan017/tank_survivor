...
public class PlayableShooter : PlayableEntity
{
    ...
    {
        base.Start();
        worldRotateX_ = transform.eulerAngles.x;
        worldRotateZ_ = transform.eulerAngles.z;
    }

    protected new void Update()
    {
        transform.eulerAngles = new Vector3(worldRotateX_, WorldRotateDegree(), worldRotateZ_);
    }
    ...
    protected float worldRotateX_, worldRotateZ_;
