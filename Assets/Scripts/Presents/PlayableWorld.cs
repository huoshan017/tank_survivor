...
public class PlayableWorld : MonoBehaviour, IPlayableContext
{
    ...
    public void Init()
    {
        world_.RegisterAfterEntityAddHandle(OnAfterAddEntityHandle);
        world_.RegisterBeforeEntityRemoveHandle(OnBeforeRemoveEntityHandle);
    }

    public void Uninit()
    {
        world_.UnregisterBeforeEntityRemoveHandle(OnBeforeRemoveEntityHandle);
        world_.UnregisterAfterEntityAddHandle(OnAfterAddEntityHandle);
    }
    ...
    bool OnAfterAddEntityHandle(uint entityInstId)
    {
    ...
    bool OnBeforeRemoveEntityHandle(uint entityInstId, int entityId)
    {
