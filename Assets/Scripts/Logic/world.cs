...
namespace Logic
{
  ...
  public class World : IContext, IMapInfo
  {
    ...
    public void UnloadMap()
    {
      ...
      {
        EntityRemoveEvent_?.Invoke(e.InstId(), e.Id());
    ...
    public void Init()
    {
      ...
      for (int i = 0; i < systemDataList_.Length; i++)
      {
        ...
        EntityAddEvent_ += sd.system.AddEntity;
        EntityRemoveEvent_ += sd.system.RemoveEntity;
    ...
    public IEntity CreateEntity(EntityDef def)
    {
      ...
      EntityAddEvent_?.Invoke(e.InstId());
      return e;
    }
    ...
    public bool RemoveEntity(uint instId)
    {
      ...
      EntityRemoveEvent_?.Invoke(instId, node.Value.Id());
    ...
    public void RegisterEntityAddHandle(Func<uint, bool> handle)
    {
      EntityAddEvent_ += handle;
    }

    public void UnregisterEntityAddHandle(Func<uint, bool> handle)
    {
      EntityAddEvent_ -= handle;
    }

    public void RegisterEntityRemoveHandle(Func<uint, int, bool> handle)
    {
      EntityRemoveEvent_ += handle;
    }

    public void UnregisterEntityRemoveHandle(Func<uint, int, bool> handle)
    {
      EntityRemoveEvent_ -= handle;
    }
    ...
    event Func<uint, bool> EntityAddEvent_;
    event Func<uint, int, bool> EntityRemoveEvent_;
